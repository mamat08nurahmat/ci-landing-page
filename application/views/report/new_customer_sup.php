...
<script type="text/javascript">
	$(function() {
		...
		function getReport(ex){
			...
			if(ex == 0){
				var urls = '<?php echo site_url('/report/get_new_customer/')?>/'+id + '/' +month+'/'+year; 
				$("#report").html("<img src='<?php echo LOAD ?>'> <span style='color:#080'>loading</span>");
				$("#report").load(urls)
			} else {
				var urls = '<?php echo site_url('/report/xls_new_customer/')?>/'+id + '/' +month+'/'+year; 
				//alert(urls);
...
<div id='content_x'>
	<div id="tabs">
        <ul>
            <li><a href="#tabs-1">REPORT NEW CUSTOMER </a></li>
        </ul>
        <div id="tabs-1">
            ...
            <table width="" border="0" cellspacing="5" cellpadding="0">
              ...
              <tr>
                ...
                <td>:</td>
              	<td colspan="4">
                	<input name="USER_NAME" id="USER_NAME" type="text" size="50" readonly="readonly" class="input">
                </td>
              </tr>
              <tr>
                ...
                <td>:</td>
              	<td colspan="4">
                	<input name="SALES_TYPE" id="SALES_TYPE" type="text" size="50" readonly="readonly" class="input">
                </td>
              </tr>
              <tr>
